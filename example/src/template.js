...
export const sourcecodeA = `<icon name="code" label="Source Code"></icon>`

export const sourcecodeB = `<icon label="No Photos">
  <icon name="camera_enhance"></icon>
  <icon name="not_interested" scale="2" class="alert"></icon>
</icon>`

export const sourcecodeC = `<icon name="baidu"></icon>
...
export const sourcecodeD = `<icon name="webpack"></icon>
<icon name="vue"></icon>
